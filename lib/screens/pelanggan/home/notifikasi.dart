...
class _NotificationScreenState extends State<NotificationScreen> {
                    ...
                    Expanded(
                      child: OutlinedButton(
                        ...
                        style: OutlinedButton.styleFrom(
                          ...
                          side: BorderSide(color: const Color(0xFFBCEFF2).withOpacity(0.8), width: 1.5),
                          shape: RoundedRectangleBorder(
      ...
      if (response.statusCode == 200) {
        ...
        var selectedRoom = rooms.firstWhere(
          (r) {
            ...
            final String nameWithKaryawan = karyawan == null ? 'Admin WishWash' : 'Karyawan ${karyawan['nama_karyawan']}';
            return name.toLowerCase().contains(targetName.toLowerCase()) ||
                   nameWithKaryawan.toLowerCase().contains(targetName.toLowerCase()) ||
        ...
        if (selectedRoom != null && mounted) {
          ...
          String name = isAdmin ? 'Admin WishWash' : karyawan['nama_karyawan'];
          ...
          return Expanded(
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: isSelected ? navyColor : Colors.white.withOpacity(0.6),
  ...
  Widget _buildBody() {
    ...
    if (filteredList.isEmpty) {
      ...
      String emptyDesc = 'Notifikasi seputar pesanan Anda akan muncul di sini.';
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: isRead ? Colors.grey.shade100 : const Color(0xFFBCEFF2).withOpacity(0.5),
            width: 1.5,
          ),
          boxShadow: [
            BoxShadow(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: GoogleFonts.poppins(
                          fontSize: 12,
                          color: isRead ? Colors.grey.shade400 : const Color(0xFF0C4B8E).withOpacity(0.7),
                          height: 1.4,
